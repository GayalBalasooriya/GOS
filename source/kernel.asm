;GOS --- The GOS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE GOS_VER '1.0'	 ;OS version number
	%DEFINE GOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as GOS and its programs
...
option_screen:
	...
	mov cx, 00101111b		; Colour: white text on light blue
	...
	os_init_msg		db '============== Welcome to GOS ===============', 0
	os_version_msg		db 'Version ', GOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', GOS_VER, 0

	dialog_string_1		db 'Welcome to GOS Operating System', 0
...
os_draw_background1:
	...
	mov cx, 00100000b		; Colour: white text on light blue
